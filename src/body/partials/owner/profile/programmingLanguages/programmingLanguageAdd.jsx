...
import { CREATE_PROGRAMMING_LANGUAGE, FETCH_CONFIG_PROFILE_PROGRAMMING_LANGUAGES_AND_SKILLS} from '../../../../../graphql/owner/profile';
...
function ProgrammingLanguageAdd(){
    ...
    const [CreateProgrammingLanguage, { loading: createLoading }] = useMutation(CREATE_PROGRAMMING_LANGUAGE, {
        update(proxy, result) {
                ...
                data:{
                    profile:{
                        programming_languages: [
                            ...CurrentData.profile.programming_languages,
                            result.data.profile.programming_language.create
                        ]
                    }
                }
            })
