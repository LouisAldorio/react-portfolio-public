...
import { DELETE_IMAGE_BY_ID, FETCH_GALLERY_CONFIG_DATA_QUERY } from '../../../../../graphql/owner/gallery';
...
function DeleteImageDialog(props){
    ...
    const [DeleteImage, { loading }] = useMutation(DELETE_IMAGE_BY_ID, {
        update(proxy, result) {
            ...
            proxy.writeQuery({
                ...
                data: {
                    gallery: {
                        photos_without_category: CurrentData.gallery.photos_without_category.filter(id => id !== result.data.gallery.delete_image.id)
                    }
                }
            })
            handleClose()
